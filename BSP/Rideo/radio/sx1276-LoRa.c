...
void SX1276LoRaInit( void )
{
    ...
    SX1276Write(REG_LR_PREAMBLELSB, 12);// RegPreambleLsb 8+4=12byte Preamble
    SX1276Write(REG_LR_TCXO, 0x12);     // External clipped sine TCXO AC-connected to XTA pin
