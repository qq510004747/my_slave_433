...
extern u32 LoRa_Frequency_Change;
/*!
...
//    SX1276LoRaSetOpMode( RFLR_OPMODE_SLEEP );
    ...
    // set the RF settings 
//	LoRaSettings.RFFrequency = LoRa_Frequency_Change;
...
uint32_t SX1276LoRaProcess( void )
{
    ...
    case RFLR_STATE_RX_INIT:
        ...
        SX1276LoRaSetOpMode( RFLR_OPMODE_STANDBY );//待命模式
    ...
    case RFLR_STATE_RX_DONE:
        ...
        if( LoRaSettings.RxSingleOn == true ) // Rx single mode
        {
            SX1276LR->RegFifoAddrPtr = SX1276LR->RegFifoRxBaseAddr;  //__指向地址     
    ...
    case RFLR_STATE_TX_INIT:
        ...
        else//( LoRaSettings.FreqHopOn == flase )
        {
            SX1276LR->RegIrqFlagsMask = RFLR_IRQFLAGS_RXTIMEOUT |
                                        RFLR_IRQFLAGS_RXDONE |
                                        RFLR_IRQFLAGS_PAYLOADCRCERROR |
